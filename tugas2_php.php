...
<body>
    <div class="container my-4">
        ...
        <div class="row">
            <div class="col-md-3">
                <h3 class="text-center">Form Pegawai</h3>
                <div class="my-5">
            ...
            <div class="col-md-9">
                ...
                <div class="my-5">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Nama Pegawai: <?= $pegawai ?></li>
                        <li class="list-group-item">Agama: <?= $agama ?></li>
                        <li class="list-group-item">Jabatan: <?= $jabatan ?></li>
                        <li class="list-group-item">Status: <?= $status ?></li>
                        <li class="list-group-item">jumlah Anak: <?= $jmlAnak ?></li>
                    </ul>
                </div>
            </div>
